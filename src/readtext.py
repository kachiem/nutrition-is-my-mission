...
#allowed = {'POTATOES': 'gucci', 'VEGETABLE OIL': 'eat ur veggies', 'SUNFLOWER': 'yummy', 'CORN': 'who doesnt love corn', 'CANOLA OIL': 'literally in everything', 'BARBECUE SEASONING': 'ey bb...q', 'SUGAR': 'fatty', 'DEXTROSE': 'ose = sugar', 'SALT': 'nacl', 'MALTODEXTRIN': 'wtf is this', 'MOLASSES': 'sugar again', 'TORULA YEAST': 'huh', 'ONION POWDER': 'ogres have layers', 'SPICES': 'this could literally mean anything', 'TOMATO POWDER': 'how can a tomato be powder', 'PAPRIKA': 'spice', 'NATURAL FLAVORS': 'this is sketch', 'CORN STARCH': 'yeet shitty food', 'CARAMEL COLOR': 'fair enough', 'YEAST EXTRACT': 'yeet yeast', 'PAPRIKA EXTRACT': 'see paprika', 'GARLIC POWDER': 'flavor', 'MUSTARD SEED OIL': 'ok'}
